...
def align_spots(adata_st_list_input, # list of spatial transcriptomics datasets
    ...
    if plot:
        ...
        plt.savefig('/home/xzhang/workplace/STitch3D-main/STitch3D/results/11.svg', format='svg')
        plt.show()
    ...
    if plot:
        ...
        plt.yticks([])
        plt.legend(loc=(1.02, .2), ncol=(len(adata_st_list)//13 + 1))
        plt.savefig('/home/xzhang/workplace/STitch3D-main/STitch3D/results/22.svg', format='svg')
        plt.show()
