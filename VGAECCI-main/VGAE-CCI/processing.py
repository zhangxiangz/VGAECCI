...
def parse_args():
    ...
    parser.add_argument('--coordinate', '-c', type=str,default='', help='Input cell coordinate data path')
...
if __name__ == '__main__':
    ...
    import copy
    from vgaecci.io import read_coordinate
    from vgaecci.plot import plot_histogram
    ...
    adj.to_csv('/home/xzhang/workplace/VGAECCI/processing-output/adj_dist%.2f'%cutoff_distance+'_neigh'+str(args.link_num)+'.csv', header=True, index=False)
